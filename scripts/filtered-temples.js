...
const temples = [
...

	{
		...
		area: 53997,
		imageUrl:"http://churchofjesuschristtemples.org/assets/img/temples/tokyo-japan-temple/tokyo-japan-temple-57276.jpg"
	},
	{
...
function createTempleCard(filteredTemples) {
	...
	filteredTemples.forEach(temple => {
		...
		dedication.innerHTML = `<span class= label>Dedication Year:</span> ${temple.dedicated}`; 
		area.innerHTML = `<span class= label>Area:</span> ${temple.area} sq ft`; 
		img.setAttribute("src", temple.imageUrl); 
		img.setAttribute("alt", `${temple.templeName} img"`);
